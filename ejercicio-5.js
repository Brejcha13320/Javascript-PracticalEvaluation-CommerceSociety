...
let jugadores = [
  new Jugador("Jesus", "Mejia", 24, "Portero"),
  new Jugador("David", "Vergara", 25, "Defensa"),
  new Jugador("Juan", "Torres", 26, "Medio"),
  new Jugador("Marcela", "Galvez", 27, "Delantero"),
];

const entrenador = new Entrenador("Carlos", "Martin", 50, 20);
